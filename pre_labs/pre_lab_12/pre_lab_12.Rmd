...
**Task** Run the following code and describe the dataframe it outputs. **Answer: It's a dataframe with info from the rds file. The data is organized into 15 columns and 499 disciplinary alerts.**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer: It is difficult for R to distinguish and group words in the way a human would.**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer: It's a dataframe with a column and a row for each individual word.**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer: It's a bar graph showing the 25 most frequent words in the original dataset of disciplinary alerts. Most of the words don't tell us much.**
...
**Task** Run the following code and describe the results. **Answer: It's a dataframe of common two-word phrases from 2024 on. These tell us a bit more about what is actually being discussed in the disciplinary alerts.**
...
**Task** Run the following code and describe the results. **Answer: The output of this code is the same as the prior question.**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer: The "patient" sentiment being positive can really throw off the analysis. In this case, it's the most common word and "patient" is probably more negative if anything. The word should be excluded.**
