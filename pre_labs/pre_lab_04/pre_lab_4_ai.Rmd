...
```{r}
task_response <- axolotr::ask(
  prompt = "Using the tidyverse library, write R code that adds up monthly profits in a chart and outputs quarterly averages. Break up the code using hard returns when necessary. Give me the code in a way that is easy to understand and copy and paste. No yapping.",
  model = "llama-3.1-8b-instant"
)
...
**Your comment: This answer is probably correct given AI's ability to code quite well, but it's hard for me to know that for sure given how its presented. It gave me an almost indecipherable block of text even though I tried asking it to make the answer a little more streamlined. I guess this answer technically is appropriate, but it wouldn't save me much time given. the time it would take to determine what all this means.**
