...
**Task** Run the following code in the gray-colored codeblock below to extract all tables in the HTML and save it as a dataframe. What do you notice about the columns? **Answer: The names of the columns could be cleaner. It is saved as a list, not a traditional dataframe.**
...
**Task** Run the following code to extract the table we want, clean up the names and change the date column to an actual date. Look at the dataframe; what other information about these releases might you want to add? **Answer: Maybe information on length of the press release, the county in concerns or maybe a byline.**
...
tags. Describe the output: **Answer: It is a list of all of the text within a**
...
**Task** Run the following code in the gray-colored codeblock below to make a dataframe. Describe the output: **Answer: Looking through the HTML, we can see the press releases have a class element that distinguishes them.**
