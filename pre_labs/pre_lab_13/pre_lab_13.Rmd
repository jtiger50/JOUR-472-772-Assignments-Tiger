...
**Task** Run the following code and describe the dataframe it outputs. **Answer: It's a table that shows the change in population by state, and how it voted in the 2020 presidential election.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer: It's a scatterplot showing GDP growth by change in population. It is hard to take anything away from this visualization.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer: It's a scatterplot showing the GDP growth by each state's per pupil spending. There seems to be a bit stronger of a connection.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer: A table showing that there seems to be somewhat of a negative correlation between per pupil spending and population change.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: The p-value of this correlation is significant. States that spent more on education lost population.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: This correlation is insignificant.**
...
**Task** Run the following code. Describe the table. What do you see? **Answer: States that voted for Biden grew more and spent more on education, but those states also grew less in population.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: This correlation is closer to being significant, but it's still short of \<0.05.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: There is a very strong correlation between per pupil spending and how a state voted in 2020.**
