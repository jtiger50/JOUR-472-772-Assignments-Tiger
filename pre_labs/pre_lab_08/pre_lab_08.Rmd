...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: There is now a title, source and labels for each axis.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: The calls are now grouped by specific dates rather than months.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: A line chart that shows how many calls there were on a given day over a year.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: The x axis is not broken down into weeks.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: The weeks along the x axis are now at a 45-degree angle to make them a bit more readable.**
