...
```{r}
  clean_names(county_voters_2016)
  clean_names(county_voters_2018)
  clean_names(county_voters_2020)
  clean_names(county_voters_2022)
```
...
```{r}
clean_names(county_voters_combined)
```
